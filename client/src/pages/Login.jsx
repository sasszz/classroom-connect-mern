  ...
  return (
    <div className='bg-[#00008B] flex flex-wrap items-center h-screen w-screen m-auto'>
        ...
        <div className='text-white m-auto w-auto'>
            ...
            <div className='border mx-20 text-white rounded-2xl px-4 py-2 my-2 w-60'>Login with Google</div>

            <Link to='/signup'>
            <div>Haven't Registered? <span className='underline'>Signup</span></div>
            </Link>
        </div>
    </div>
  )
